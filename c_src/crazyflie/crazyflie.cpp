...
static void *crazyflie_thread(void *arg) {
    ...
    enif_fprintf(stderr, "Resetting log toc\r\n");
    ...
    enif_fprintf(stderr, "Setting callbacks.\r\n");
    ...
    enif_fprintf(stderr, "setting imu block callbacks.\r\n");
    ...
    enif_fprintf(stderr, "setting log block2 callbacks.\r\n");
    ...
    enif_fprintf(stderr, "Requesting params \r\n");
    ...
    enif_fprintf(stderr, "entering loop\r\n");
